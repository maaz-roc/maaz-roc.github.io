...
class Drawing {
     ...
     */
    drawPolyline(points, myLineStyle, closed = false, startWidth = 0, endWidth = 0) {
        
        // let polyLine =  new Polyline(points, closed, startWidth, endWidth);
        
        
        
        // console.log(this.lineType);
        // console.log(polyLine.lineType);
        // console.log(polyLine.lineTypeName);
        // console.log(this.lineTypes);
        // polyLine.lineType = true;
        // console.log(polyLine);
        // polyLine.lineTypeName = "DOTTED";
        // polyLine.lineTypes = "DOTTED";
        // polyLine.lineTypeName = this.lineTypes['DOTTED'];
        // console.log(polyLine.lineTypeName);
        this.activeLayer.addShape(
        ...
        // this.lineType = true;
        // if (myLineStyle == "CONTINUOUS"){
        //     this.tags.lineTypeName = "CONTINUOUS" ;
        // }
        // else if (myLineStyle == "DOTTED"){
        //     this.lineType = true ;
        //     this.lineTypeName = this.lineTypes.DOTTED;
            
        // }
        // else if (myLineStyle == "DASHED"){
        //     this.tags.lineTypeName = "DASHED" ;
        // }
        // else{
        //     this.tags.lineTypeName = "byLayer";
